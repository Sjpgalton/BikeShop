...
using Redweb.BikeShop.Core.ViewModels.Manage;
...
namespace Redweb.BikeShop.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public ManageController(IdentityConfig.ApplicationUserManager userManager, IdentityConfig.ApplicationSignInManager signInManager)
        {
